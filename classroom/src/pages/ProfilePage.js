...
import dummyImage from './avatar-1577909_640.png';
    ...
    const handleCreateClassroom = async () => {
        try{
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/class/create`,{
                ...
                body: JSON.stringify({name:classroomName,description:description }),
            ...
            toast.error('An error occured while creating classroom')
        }
    }
